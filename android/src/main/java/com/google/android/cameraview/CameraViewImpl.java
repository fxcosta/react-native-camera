...
abstract class CameraViewImpl {
    ...
    /**
     * @return {@code true} if the implementation was able to start the camera
     *         session.
     */
    ...
    abstract boolean record(String path, int maxDuration, int maxFileSize, boolean recordAudio,
