...
public class CameraViewManager extends ViewGroupManager<RNCameraView> {
  public enum Events {
    ...
    EVENT_ON_TEXT_RECOGNIZED("onTextRecognized"), EVENT_ON_PICTURE_SAVED("onPictureSaved");
  ...
  public void setExposureCompensation(RNCameraView view, float exposureCompensation) {
